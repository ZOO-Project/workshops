...
``docker/ws2023_sp/Hello.zcfg`` file 
...
If you copy the ``Hello.zcfg`` file in a sub-directory (``ws2023``) of
your ZOO Kernel  then, you will be able to request for DescribeProcess
using the ``ws2023.Hello``  Identifier. The ``ws2023.Hello``
service should also be listed from Capabilities document.

.. code-block:: none
    
    cp docker/ws2023_sp/Hello.zcfg docker/ws2023
...
Now, you should find your `ws2023.Hello`processes listed as shown bellow.
...
To access the detailled description of the ws2023.Hello process, you
can use the following endpoint: `/processes/ws2023.Hello 
<http://localhost/ogc-api/processes/ws2023.Hello>`__.
...
execute request based on the description of the ws2023.Hello process, you
can use the following URL: `/processes/ws2023.Hello.html 
<http://localhost/ogc-api/processes/ws2023.Hello.html>`__.
...
.. literalinclude:: files/ws2023_Hello.json
...
``docker/ws2023_sp/test_service.py`` file.

.. literalinclude:: ./files/test_service.py

Once you finish editing the file, you should copy it in the ``ws2023`` directory: 

.. code-block:: none
    
    cp docker/ws2023_sp/test_service.py docker/ws2023
