...
ZOO-Project with the workshop2023 specific data and configuration
...
.. code-block:: guess
    ...
    cd ZOO-Project
    curl -o docker-compose.yml https://raw.githubusercontent.com/ZOO-Project/workshops/master/2023/foss4g/files/sample-docker-compose.yml
    curl -o zoows2023.tar.bz2 http://geolabs.fr/dl/zoows2023.tar.bz2
    tar -xvf zoows2023.tar.bz2
    docker-compose up -d    
